...
class mt_users(osv.osv):
	...
	'dep_name' : fields.many2one('m.department', 'Department', required=True),
	...
	'update_user_id': fields.many2one('res.users', 'Recent Update By', readonly=True),
	'update_date': fields.datetime('Recent Update On', readonly=True),
	...
	def write(self, cr, uid, ids, vals, context=None):
		...
		return super(mt_users, self).write(cr, uid, ids, vals, context)
